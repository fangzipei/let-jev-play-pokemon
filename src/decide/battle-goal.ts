...
export const BATTLE_GOAL =
  ...
  'Read its summary and recent_turns together with the current snapshot: the summary retains known participants, fainted Pokemon, revealed information and resources; recent_turns covers both sides\' server-confirmed events. ' +
